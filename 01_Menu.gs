function onOpen() {
  SpreadsheetApp.getUi()
    ...
    .addItem('MODALITA MANUALE Attivita - scheda selezionata', 'activateManualActivitiesEmergency')
    .addItem('MODALITA MANUALE Attivita - tutte le schede', 'activateManualActivitiesEmergencyAll')
    .addSeparator()
