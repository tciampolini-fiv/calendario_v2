...
function onEdit(e) {
  ...
  if (sheet.getName()===EVENT_APP.SHEETS.PARTICIPANTS) {
    ...
    if ((row>=3&&row<=17)||(row>=20&&row<=39)) eventRefreshExpenseDashboardV8_();
  }
}
